...
class PinEntryEditText : AppCompatEditText {
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        textPaint?.color = ContextCompat.getColor(context, R.color.colorTheme)
        ...
        textEmptyPaint?.color = ContextCompat.getColor(context, R.color.colorTheme)
    ...
    private fun updateColorForLines(next: Boolean) {
        if (isFocused) {
            ...
            mLinesPaint?.color = ContextCompat.getColor(context, R.color.colorThemeVariant)
            if (next) {
                mLinesPaint?.color = ContextCompat.getColor(context, R.color.colorTheme)
            }
        } else {
            mLinesPaint?.strokeWidth = mLineStroke
            mLinesPaint?.color = ContextCompat.getColor(context, R.color.colorThemeVariant)
